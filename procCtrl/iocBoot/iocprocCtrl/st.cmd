...
dbLoadRecords("$(TOP)/db/procServControl.template", "P=$(DEVICE_PROCSERV_PREFIX),PORT=port2,SHOWOUT=1, MANUALSTART=,name=$(DEVICE_PROCSERV_PREFIX)")
drvAsynIPPortConfigure("port2", "unix://$(DEVICE_PROCSERV_SOCK)")
...
seq(procServControl,"P=$(DEVICE_PROCSERV_PREFIX)")
date
dbl
